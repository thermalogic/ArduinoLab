...
#define TONE_PIN            4
#define APPLICATION_PIN     5
#define ALTERNATIVE_IR_FEEDDEV_BACK_LED_PIN 6 // E.g. used for examples which use LED_BUILDIN for example output.
...
#define ALTERNATIVE_IR_FEEDDEV_BACK_LED_PIN 7 // E.g. used for examples which use LED_BUILDIN for example output.
#define _IR_TIMING_TEST_PIN 8
...
#define ALTERNATIVE_IR_FEEDDEV_BACK_LED_PIN 19 // E.g. used for examples which use LED_BUILDIN for example output.
